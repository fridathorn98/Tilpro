from bintreeFile import Bintree #importera
    ...
    for i, x in enumerate(ord):
        for a in alfabeta:
            ...
            if x!=a: #lägg inte in samma ord
                ...
                if not word1 in barn:#.__contains__(word1): #om giltigt och ej finns
...
########################################
# Bara ca 4 rader behövde bytas ut
# Det var mycket snabbare med hashtabell än binärt sökträd
# I koden görs bredden först sökning, vilket inte utnyttjar strukturen på
# binärträdet. Därmed bestäms tiden hos koden främst av komplexiteten på
# åtkomst i hashtabell/träd och därmed är hastabellen snabbare
# Åtkomst är O(log(N)) respektive O(1)
