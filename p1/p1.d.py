...
# global variables
# Tre saker som skiljer sig mellan urlen och utskriften
# 1. Alla event är förskjuta ett steg
#       event 1 sker på dagen för event 2 osv
# 2. Året står inte med i utskriften
# 3. Sista eventet (trettondedag jul) finns inte med i utskriften
...
## IN - fildatan
##
## OUT - fildatan sorterad i event, veckor, tider, datum och veckodagar
##
...
##
## get file content
## Tar filnamnet som INdata och ger filinnehållet som UTdata
##
## read()
## IN - förväntas vara en sträng (read)
## OUT - lista/vektor av rader
##
## realines()
## IN -
## OUT - en sträng
...
def main():
    ...
    filedata  = get_file_content(filnamn)
